package com.android.inputmethodcommon.opengl;
/*
...
import com.android.inputmethodcommon.opengl.Keyboard.Key;
 ...
 */
public class KeyboardSurfaceView extends View implements View.OnClickListener {
    /**
    ...
    private KeyboardSurfaceView mMiniKeyboard;
    ...
    Handler mHandler;
    public KeyboardSurfaceView(Context context, AttributeSet attrs) {
        this(context, attrs, R.attr.keyboardViewStyle);
    }
    public KeyboardSurfaceView(Context context, AttributeSet attrs, int defStyleAttr) {
        this(context, attrs, defStyleAttr, 0);
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public KeyboardSurfaceView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        mBackgroundDimAmount = getBackgroundDimAmount();
    ...
    private float getBackgroundDimAmount() {
        ...
        if (mGestureDetector == null) {
            mGestureDetector = new GestureDetector(getContext(), new GestureDetector.SimpleOnGestureListener() {
                ...
                public boolean onFling(MotionEvent me1, MotionEvent me2,
                    ...
                    float endingVelocityX = mSwipeTracker.getXVelocity();
                    float endingVelocityY = mSwipeTracker.getYVelocity();
     ...
     * @see KeyboardSurfaceView#isShifted()
     */
     ...
     * @see KeyboardSurfaceView#setShifted(boolean)
     */
    ...
    private void onBufferDraw() {
        ...
        Key[] keys = mKeys;
        Key invalidKey = mInvalidatedKey;
        ...
        for (int i = 0; i < keyCount; i++) {
            ...
            if (label != null) {
                ...
                int drawableX = (key.width - padding.left - padding.right
    ...
    private void showPreview(int keyIndex) {
        ...
        PopupWindow previewPopup = mPreviewPopup;
    ...
    private void showKey(int keyIndex) {
        ...
        mPreviewText.getBackground().setState(
                key.popupResId != 0 ? LONG_PRESSABLE_STATE_SET : View.EMPTY_STATE_SET);
    ...
    protected boolean onLongPress(Key popupKey) {
        ...
        if (popupKeyboardId != 0) {
            ...
            int x = mPopupX + mMiniKeyboardContainer.getPaddingRight() + mCoordinates[0];
            int y = mPopupY + mMiniKeyboardContainer.getPaddingBottom() + mCoordinates[1];
